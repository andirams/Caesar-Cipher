...
public class encdec {
    public static void main(String[] args) {
        ...
        loop1: for (int a = 0; a < kata.length(); a++) {
            ...
            // Jika plain text tidak mengandung huruf maka, langsung dimasukkan ke variable
            // cipher
        ...
        if (jawab.equalsIgnoreCase("Y")) {
            ...
            // Proses Dekrip
            loop1: for (int a = 0; a < cipher.length(); a++) {
                ...
                for (int b = 0; b < huruf.length; b++) {
                    ...
                    if (index_cipher != -1) {
                        ...
                        // jika (nomor_karakter_cipher - key) < 0 maka, 26 + (nomor_karakter_cipher -
                        // key)
                        // jika (nomor_karakter_cipher - key) >= 0 maka, (nomor_karakter_cipher - key)
                        // mod 26
                        plaintext += ((index_cipher - key) >= 0) ? huruf[(index_cipher - key) % 26]
